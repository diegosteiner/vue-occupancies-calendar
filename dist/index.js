...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(exports, require("./CalendarMonth.vue"), require("moment"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.CalendarMonth, global.moment);
    global.Calendar = mod.exports;
  }
})(this, function (_exports, _CalendarMonth, _moment) {
  "use strict";
  ...
  _CalendarMonth = _interopRequireDefault(_CalendarMonth);
  ...
  var _default = {
    components: {
      CalendarMonth: _CalendarMonth["default"]
    },
    props: {
      displayMonths: {
        type: Number,
    ...
    data: function data() {
      var firstDate = (0, _moment["default"])(this.firstDate);
      return {
        firstMonth: (firstDate.isValid() ? firstDate : (0, _moment["default"])()).startOf("month")
      };
    },
    computed: {
      years: function years() {
        return _toConsumableArray(new Set(this.months.map(function (m) {
          return m.year();
        }))).join("/");
      },
      months: function months() {
        ...
        for (var i = 0; i < this.displayMonths; i++) {
          months.push((0, _moment["default"])(this.firstMonth).add(i, "month"));
        }
    ...
    methods: {
      prev: function prev() {
        this.firstMonth = (0, _moment["default"])(this.firstMonth).subtract(1, "month");
      },
      next: function next() {
        this.firstMonth = (0, _moment["default"])(this.firstMonth).add(1, "month");
      }
    }
  };
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var _default = {
    ...
    data: function data() {
      return {
        firstDate: (0, _moment["default"])(this.datetime, "Y-MM")
      };
    },
    computed: {
      datesToDisplay: function datesToDisplay() {
        var date = (0, _moment["default"])(this.firstDate);
        var dates = [];

        while (date.isSame(this.firstDate, "month")) {
          dates.push((0, _moment["default"])(date));
          date.add(1, "day");
        }
      ...
      weekdayNames: function weekdayNames() {
        _moment["default"].locale(this.locale);

        var weekdays = _moment["default"].weekdaysShort().slice(0);
      ...
      monthName: function monthName() {
        ...
        return (0, _moment["default"])(this.firstDate).format("MMMM Y");
      },
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
...
})(this, function (_exports, _Calendar, _CalendarMonth) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  Object.defineProperty(_exports, "Calendar", {
    enumerable: true,
    get: function get() {
      return _Calendar["default"];
    }
  });
  Object.defineProperty(_exports, "CalendarMonth", {
    enumerable: true,
    get: function get() {
  ...
  var _default = {
    install: function install(Vue) {
      Vue.component('calendar', _Calendar["default"]);
      Vue.component('calendar-month', _CalendarMonth["default"]);
    }
  };
  _exports["default"] = _default;
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.prevMonthLabel))]), _vm._v(" "), _c('header', [_vm._v(_vm._s(_vm.years))]), _vm._v(" "), _c('button', {
    on: {
      "click": function($event) {
        $event.preventDefault();
  ...
  }, [_vm._v(_vm._s(_vm.nextMonthLabel))])]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.prevMonthLabel))]), _vm._v(" "), _c('footer'), _vm._v(" "), _c('button', {
    on: {
      "click": function($event) {
        $event.preventDefault();
        return _vm.next($event)
  ...
  }, [_vm._v(_vm._s(_vm.nextMonthLabel))])])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('header', [_vm._v(_vm._s(_vm.monthName))]), _vm._v(" "), _c('div', {
    staticClass: "calendar-week"
  }, _vm._l((_vm.weekdayNames), function(weekday) {
    return _c('span', {
      key: weekday
    }, [_vm._v(_vm._s(weekday))])
  }), 0), _vm._v(" "), _c('div', {
    staticClass: "calendar-days"
  }, [_vm._l((_vm.monthStartsAfter), function(n) {
    return _c('div', {
      key: n,
    ...
    }, [(_vm.freeze) ? _vm._o([_vm._t("default", null, null, date)], 0, date.format('Y-MM-DD')) : [_vm._v("--" + _vm._s(date.format("D")) + "--")]], 2)
  })], 2)])
},staticRenderFns: []}
...
var update = __webpack_require__(3)("73a700d3", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("d142f4f6", content, true, {});
